...
view = this
    ...
    this.element.innerHTML = `
      ...
      <span class="inline-block-tight btn icon icon-pandoc"           data-id="process">        Process</span>
      <span class="inline-block-tight btn icon icon-file-pdf"         data-id="save-pdf">       Save PDF</span>
      <span class="pandoc-pdf-spacer"></span>
      <span class="inline-block-tight btn icon icon-three-bars"       data-id="toggle-log">     Log</span>
      <span class="inline-block-tight btn icon icon-gear"             data-id="open-defaults">  Open Defaults</span>
      <span class="pandoc-pdf-spacer"></span>
      <span class="inline-block-tight btn icon icon-file-directory"   data-id="show-files">     Files</span>
