...
view = this // HACK
    ...
    this.element.innerHTML = `
      ...
      <span class="inline-block-tight btn icon icon-gear"
        data-id="open-defaults"
        title="Open Source Defaults File in Atom"></span>
      <span class="pandoc-pdf-spacer"></span>
    ...
    this.bProcess = this.element.querySelector('[data-id="process"]')
    ...
    this.bProcess.addEventListener('click', (event) => this.process())
  ...
  // interface for PandocPdfProcessor
  // log Pandoc call
  logCall(args) {
