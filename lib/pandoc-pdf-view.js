...
view = this // HACK
    ...
    this.element.innerHTML = `
      ...
      <span class="pandoc-pdf-heading inline-block-tight text-highlight">
        Pandoc/PDF
      </span>
    ...
    this.element.querySelector('[data-id="show-help"]').addEventListener(
      'click', (e) => atom.workspace.open('markdown-preview://' +
        path.join(__dirname, '..', 'doc', 'reference.md'), {split: 'right',
