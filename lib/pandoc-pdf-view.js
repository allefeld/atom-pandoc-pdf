...
export default class PandocPdfView {
  ...
  constructor(editor) {
    ...
    this.element.innerHTML = `
      ...
      <span class="inline-block btn">Process</span>
      <span data-id="toggle-log" class="inline-block btn">Log</span>
      <div class="pandoc-pdf-dialog" style="display: none">
        <div>
          <span class="inline-block text-highlight">Pandoc/PDF Log</span>
          <span data-id="hide-log" class="inline-block close-button icon-x"></span>
        </div>
        <div class="pandoc-pdf-log">
        </div>
      </div>
      <span data-id="close-view" class="inline-block close-button icon-x"></span>
    `
