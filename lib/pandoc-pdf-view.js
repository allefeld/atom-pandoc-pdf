...
view = this // HACK
    ...
    this.element.innerHTML = `
      ...
      <div class="pandoc-pdf-dialog" style="display: none">
        ...
        <div class="pandoc-pdf-log"                                   data-id="log-text" >
        </div>
      </div>
    `
    ...
    // element references
    this.toggleLog = this.element.querySelector('[data-id="toggle-log"]')
    ...
    this.toggleLog.addEventListener('click', (event) => this.showLog())
    ...
    for (let line of lines) {
      ...
      if (line.startsWith('[WARNING]') ||
        line.startsWith('pandoc-citeproc:')) {
          ...
          this.toggleLog.classList.add('warning')
      }
